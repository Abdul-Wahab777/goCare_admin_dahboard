...
import 'package:thinkcreative_technologies/Screens/authentication/admin_login.dart';
...
import 'package:thinkcreative_technologies/Utils/batch_write_component.dart';
import 'package:thinkcreative_technologies/Utils/custom_url_launcher.dart';
import 'package:thinkcreative_technologies/Widgets/error_codes.dart';
...
//   fun()async{
//  Firebaseu  await FirebaseAuth.instance.currentUser();
//   }
     ...
     isSecuritySetupPending == true
        ...
        : isprocessing == true
            ...
            : isready == false
                ...
                : FirebaseAuth.instance.currentUser==null? AdminLogin(doc: doc!,):
                AdminApp(
                    doc: doc!,
                  );
  
    // return doc!=null? AdminApp(doc: doc!):Center(child: CircularProgressIndicator(),);
  }
